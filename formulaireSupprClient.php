...
<html lang="fr">
	...
	<head>
		...
		<title>
			Fomulaire Suppression Clients Maison Nomade
		</title>
		...
		<form method="post" action="SupprClient.php">
			...
			<table class="table">
				...
				<tr>
					...
					<th>Formulaire pour supprimer un client :</th>
        
				</tr>
				</thead>
				<tbody>
					<tr>
						<td><label for="id" > Identifiant Client: </label></td>
			...
			<input type="submit" value="Valider" onclick=window.location.href='formulaireSupprClient.php'/>
		</form>
		</section>
